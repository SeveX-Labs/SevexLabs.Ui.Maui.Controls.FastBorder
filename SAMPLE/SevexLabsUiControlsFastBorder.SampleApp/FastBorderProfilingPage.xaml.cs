...
public partial class FastBorderProfilingPage : ContentPage
{
    ...
    public FastBorderProfilingPage()
        : this(new BorderProfilingOptions(), 0, null, false)
    {
    }

    internal FastBorderProfilingPage(
    ...
    private void BuildContent()
    {
        _buildResult = BorderProfilingSupport.BuildInto(
            ItemsHost,
            BorderProfilingTarget.FastBorder,
            _options,
            isWarmUp: false);
    }
    ...
    private BorderProfilingNavigationResult CreateResult()
    {
        ...
        {
            Target = BorderProfilingTarget.FastBorder,
